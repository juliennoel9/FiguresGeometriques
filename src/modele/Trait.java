...
public class Trait extends FigureColoree {
     ...
     * @param p2      Point d'arrive du trait
     */
    public Trait(Color couleur, Point p1, Point p2, boolean mainLevee) {
        this.couleur = couleur;
        tab_mem.add(p1);
        tab_mem.add(p2);
    ...
    public boolean isInSelection(MouseEvent e) {
        ...
        if (!tab_mem.isEmpty()) {
            ...
            if (!mainLevee) {
                ...
                if (vectP1P2.getX() * vectP1S.getY() - vectP1P2.getY() * vectP1S.getX() >= -2000
                    && vectP1P2.getX() * vectP1S.getY() - vectP1P2.getY() * vectP1S.getX() <= 2000) {
                    if (vectP1P2.getY() != 0) {
                        ...
                        if ((double) vectP1S.getY() / vectP1P2.getY() >= 0
                            && (double) vectP1S.getY() / vectP1P2.getY() <= 1) {
                            selectionne();
                            return true;
                        }
                    }
